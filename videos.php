<html>
	...
	<body>
		...
		<br>
		<br> 
		<h1 class='text-center' style="font-family:'Orbitron', sans-serif;padding:10px;"><i class="fa fa-video-camera" aria-hidden="true"></i>&nbsp;Videos</h1>
...
<div class="nav navbar-inverse foot" id="bottom-nav">
 ...
 <div id="myModal" class="modal fade" role="dialog">
		...
		<script id="youtubeputsrc" type="text/x-handlebars-template">
			{{#each link}}
			<div class="col-lg-3 col-4-md col-sm-12 col-xs-12 center-block">
			<p>
			<iframe width="90%" height="40%" src="{{account}}" frameborder="0" allowfullscreen class="center-block"></iframe>
